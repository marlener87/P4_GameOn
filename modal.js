...
function closeModal() {
  ...
  // permet de cacher le formulaire pour afficher la slide de fermeture
  const openForm = document.querySelector("#openForm");
  openForm.classList.remove("hidden");

  // permet de cacher le slide de fermeture
  const closeForm = document.querySelector("#closeForm");
  closeForm.classList.remove("active");

  // permet de retourner à la page d'accueil du site
  const myBody = document.querySelector("body");
...
btnSubmitValidationForm.addEventListener("click", (event) => {
  ...
  if (
    ...
    isMyButtonIsValid.isBoxChecked
  ) {
    const openForm = document.querySelector("#openForm");
